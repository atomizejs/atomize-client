    ...
    (function () {
        ...
        if (typeof exports !== "undefined") {
            ...
            Atomize = function (ClientCtor, serverEventEmitter) {
                var FakeConn, inflight, stm, client;
            ...
            if (undefined === window.SockJS) {
                ...
                Atomize = function (url, authenticateFun) {
                    ...
                    if (undefined === url) {
                        ...
                        sockjs.onopen = function () {
                            ...
                            ready = undefined === authenticateFun || authenticateFun(undefined, sockjs);
                            if (!ready) {
                                return;
                            }
                        ...
                        sockjs.onmessage = function (e) {
                            var txnLog, txnId, txn;
                            if (!ready) {
                                ready = authenticateFun(e, sockjs);
