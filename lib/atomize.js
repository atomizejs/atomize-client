    ...
    (function () {
        ...
        function TVar(id, obj, stm) {
            ...
            if (typeof obj === "function") {
                this.proxied = this.functionHandlerMaker();
            } else {
        ...
        TVar.prototype = {
            ...
            functionHandlerMaker: function () {
                var self, callTrap, ctrTrap, myCtr;
                self = this;
                callTrap = function () {
                    return self.raw.apply(this, arguments);
                };
                ctrTrap = function () {
                    var args, Ctr;
                    args = arguments;
                    Ctr = function () {
                        self.raw.apply(this, args);
                    };
                    self.raw.prototype = self.proxied.prototype;
                    Ctr.prototype = self.proxied.prototype;
                    return new Ctr();
                };
                this.handler = this.objHandlerMaker();
                return this.createFunctionProxy(this.handler, callTrap, ctrTrap);
            },
            ...
            createFunctionProxy: function (handler, callTrap, ctrTrap) {
                if (this.hasNativeProxy) {
                    return Proxy.createFunction(handler, callTrap, ctrTrap);
                } else {
                    return this.raw;
                }
            },
                ...
                return {
                    ...
                    getPropertyDescriptor: function (name) {
                        ...
                        if (undefined === Object.getPropertyDescriptor) {
                            tmp = undefined;
                            // TODO fixme - might be sufficient to have rewritten Object.getOwnPropertyDescriptor
                            proto = self.proxied;
                    ...
                    getPropertyNames: function () {
                        ...
                        seen = {};
                        tmp = undefined;
                        // TODO fixme - might be sufficient to have rewritten Object.getOwnPropertyNames
                        proto = self.proxied;
                        while (proto !== undefined && proto !== null && proto !== tmp) {
                            tmp = proto;
                    ...
                    defineProperty: function (name, desc) {
                        ...
                        // TODO fixme - might be sufficient to have rewritten Object.defineProperty
                        if (stm.inTransaction()) {
                            if (undefined !== desc.value &&
                    ...
                    enumerate: function () {
                        ...
                        stm.recordRead(self);
                        result = [];
                        // TODO fixme - might be sufficient to have rewritten Object.keys
                        if (stm.inTransaction()) {
                            seen = {"_map": true};
                            tmp = undefined;
                            proto = self.proxied;
        ...
        Transaction.prototype = {
            ...
            recordWrite: function (parent, name, value) {
                // will need rewritten Object.getOwnPropertyDescriptor
        ...
        STM.prototype = {
            ...
            access: function (obj, field) {
                ...
                if (undefined !== result && Function === result.constructor) {
                    func = function () {
                        var args = arguments;
