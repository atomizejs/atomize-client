            ...
            objHandlerMaker: function () {
                ...
                handler = {
                    ...
                    getPropertyDescriptor: function (name) {
                        ...
                        var visited, desc, obj, value;
                        visited = [];
                        obj = self.proxied;
                        while (obj !== undefined && obj !== null && -1 === visited.indexOf(obj)) {
                            obj = stm.ensureTVar(obj).proxied;
                    ...
                    getPropertyNames: function () {
                        ...
                        stm.recordRead(self);
                        var result, seen, visited, names, obj, i;
                        seen = {};
                        visited = [];
                        obj = self.proxied;
                        // the final obj !== Object.prototype is probably a bug in chrome/v8:
                        // http://code.google.com/p/v8/issues/detail?id=2145
                        while (obj !== undefined && obj !== null
                               && -1 === visited.indexOf(obj) && obj !== Object.prototype) {
                            obj = stm.ensureTVar(obj).proxied;
