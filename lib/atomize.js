...
(function (window) {
    ...
    (function () {
            ...
            objHandlerMaker: function () {
                ...
                handler = {
                    ...
                    getPropertyDescriptor: function (name) {
                        ...
                        var visited, desc, proto;
                        if (undefined === Object.getPropertyDescriptor) {
                            visited = [];
                            proto = self.proxied;
                            while (proto !== undefined && proto !== null && -1 === visited.indexOf(proto)) {
                                if ("_map" === name || ! stm.inTransaction()) {
                                    desc = Object.getOwnPropertyDescriptor(proto, name);
                                } else if (stm.transactionFrame.isDeleted(proto, name)) {
                                    return undefined;
                                } else {
                                    desc = stm.transactionFrame.get(proto, name);
                                    if (undefined === desc) {
                                        desc = Object.getOwnPropertyDescriptor(proto, name);
                                    }
                                }
                                if (undefined === desc) {
                                    ...
                                    if (util.hasOwnProp.call(desc, 'configurable')) {
                                        desc.configurable = true; // should go away with direct proxies
                                    }
                                    return desc;
                                }
                    ...
                    getPropertyNames: function () {
                        ...
                        stm.recordRead(self);
                        var result, seen, visited, names, proto, i;
                        seen = {};
                        visited = [];
                        proto = self.proxied;
                        while (proto !== undefined && proto !== null && -1 === visited.indexOf(proto)) {
                        ...
                        if ("_map" === name || "__proto__" === name || ! stm.inTransaction()) {
                            ...
                            if (undefined === desc) {
                                if (util.hasOwnProp.call(self.raw, name)) {
                                    ...
                                    return stm.access(stm.ensureTVar(result).proxied, name, receiver);
                                }
                            } else {
        ...
        STM.prototype = {
            ...
            access: function (obj, field, receiver) {
                var tvar, result, func;
                tvar = this.asTVar(obj);
                if (undefined === tvar) {
                    result = obj[field];
                } else {
                    result = tvar.handler.get(receiver, field);
                }
                if (undefined !== result && null !== result && 'function' === typeof result) {
                    func = function () {
                        var args = arguments;
                        return result.apply(receiver, args);
                    };
                    func.apply = function (thisObj, argsArray) {
                        return result.apply(thisObj, argsArray);
                    };
                    func.call = function () {
    ...
    (function () {
        ...
        p = {
            ...
            access: function (obj, field) {
                return this.stm.access(obj, field, obj);
            },
