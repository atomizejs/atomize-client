            ...
            objHandlerMaker: function () {
                ...
                handler = {
                    ...
                    getPropertyDescriptor: function (name) {
                        ...
                        while (obj !== undefined && obj !== null && -1 === visited.indexOf(tvar)) {
                    ...
                    getPropertyNames: function () {
                        ...
                        while (obj !== undefined && obj !== null
                               && -1 === visited.indexOf(tvar) && Object.prototype !== obj) {
                            tvar = stm.ensureTVar(obj);
                            obj = tvar.proxied;
        ...
        Transaction.prototype = {
            ...
            commit: function (result) {
                ...
                if (util.hasOwnProp.call(this, 'parent')) {
                    ...
                    // if we didn't write any thing then we
                    // immediately succeed. We only need to go to the
                    // server if we created new stuff.
                    if (0 === util.keys(this.written).length) {
                        if (0 !== util.keys(this.created).length) {
                    ...
                    success = function () {
                        ...
                        ids = util.keys(self.written).sort();
            ...
            maybeSendRetry: function () {
                var self, restart, txnLog, worklist, obj, keys, i;
                ...
                if (util.hasOwnProp.call(obj, 'written') && obj.written) {
                    ...
                    for (i = 0; i < keys.length; i += 1) {
                        ...
                        for (j = 0; j < names.length; j += 1) {
                            ...
                            } else if (util.hasOwnProp.call(value, 'value') &&
                                       (undefined === value.value || null === value.value)) {
                        ...
                        this.connect = function () {
                            ...
                            self.sockjs.onmessage = function (e) {
                                ...
                                default:
                                    ...
                                    self.stm.log(JSON.stringify(txnLog));
                                    throw new InternalException();
                                }
                            };
                        };
